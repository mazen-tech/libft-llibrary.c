...
#    Makefile                                           :+:      :+:    :+:    #
#                                                     +:+ +:+         +:+      #
#    By: maabdela <maabdela@42.fr>                  +#+  +:+       +#+         #
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/12/20 04:29:14 by jotavare          #+#    #+#              #
#    Updated: 2024/03/08 14:32:50 by maabdela         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
CC = cc
...
$(NAME): $(OBJS)
	@$(CC) $(CFLAGS) -c $(SRCS) # Compile all source files
	@echo "Compilation [Success]" # Indicate successful compilation
	@ar rc $(NAME) $(OBJS)
